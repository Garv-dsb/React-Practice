    ...
    return (
        <div className='border border-default flex flex-col h-[350px] w-[300px] p-[5px] rounded-lg'>
            ...
            <div className='flex justify-between border-b border-default mb-[5px] p-[5px] '>
                <p className='text-[10px] opacity-50'>Rating Count :{product.rating.count}</p>
                <p className='text-[10px] opacity-50'>Rating Star : ⭐{product.rating.rate}</p>
            </div>
            ...
            <div className='p-[10px] flex flex-col gap-[5px] '>
                {/* title  */}
                <h3 className='text-sm font-semibold opacity-75'>{product.title.slice(0, 25)}</h3>

                {/* description  */}
                <p className='text-sm opacity-50'>{product.description.slice(0, 25)}...</p>
