                        ...
                        return (
                            ...
                            >
                                ...
                                <div className='flex justify-between border-b border-default mb-[5px] p-[5px] '>
                                    <p className='text-[10px] opacity-50'>Rating Count :{prod.rating.count}</p>
                                    <p className='text-[10px] opacity-50'>Rating Star : ⭐{prod.rating.rate}</p>
                                </div>
                                ...
                                <div className='p-[10px] flex flex-col gap-[5px] '>
                                    {/* title  */}
                                    <h3 className='text-sm font-semibold opacity-75'>{prod.title.slice(0, 25)}</h3>

                                    {/* description  */}
                                    <p className='text-sm opacity-50'>{prod.description.slice(0, 25)}...</p>
...

            {
                cartData.length > 0 && (
                    <div>
                        ...
                        <div className='border-t border-default mt-[10px]'>
